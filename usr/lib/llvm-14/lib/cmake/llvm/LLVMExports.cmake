...
get_filename_component(_realOrig "/usr/lib/llvm-14/lib/cmake/llvm" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/llvm-14/lib/cmake/llvm")
endif()
unset(_realOrig)
unset(_realCurr)
...
# Create imported target LLVMM68kCodeGen
add_library(LLVMM68kCodeGen STATIC IMPORTED)

set_target_properties(LLVMM68kCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAnalysis;LLVMAsmPrinter;LLVMCodeGen;LLVMCore;LLVMGlobalISel;LLVMMC;LLVMSelectionDAG;LLVMSupport;LLVMTarget;LLVMM68kDesc;LLVMM68kInfo"
)

# Create imported target LLVMM68kInfo
add_library(LLVMM68kInfo STATIC IMPORTED)

set_target_properties(LLVMM68kInfo PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMMC;LLVMSupport"
)

# Create imported target LLVMM68kDesc
add_library(LLVMM68kDesc STATIC IMPORTED)

set_target_properties(LLVMM68kDesc PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMMC;LLVMMCDisassembler;LLVMSupport;LLVMM68kInfo"
)

# Create imported target LLVMM68kAsmParser
add_library(LLVMM68kAsmParser STATIC IMPORTED)

set_target_properties(LLVMM68kAsmParser PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMMC;LLVMMCParser;LLVMSupport;LLVMM68kCodeGen;LLVMM68kInfo"
)

# Create imported target LLVMM68kDisassembler
add_library(LLVMM68kDisassembler STATIC IMPORTED)

set_target_properties(LLVMM68kDisassembler PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMM68kDesc;LLVMM68kInfo;LLVMMCDisassembler;LLVMSupport"
)
...
set_target_properties(LLVMExegesis PROPERTIES
  INTERFACE_LINK_LIBRARIES "pfm;LLVMAnalysis;LLVMCodeGen;LLVMCore;LLVMExecutionEngine;LLVMGlobalISel;LLVMMC;LLVMMCDisassembler;LLVMMCJIT;LLVMMCParser;LLVMObject;LLVMObjectYAML;LLVMRuntimeDyld;LLVMSupport"
)
